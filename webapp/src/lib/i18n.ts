...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    txt_unbind: "Unbind",
    txt_unbind_yubikey: "Unbind YubiKey",
    txt_unbind_yubikey_confirm_message: "Unbind YubiKey with public ID {publicId}?",
    txt_unbind_yubikey_failed: "Unbind YubiKey failed",
    txt_disable_yubikey: "Disable YubiKey",
    txt_disable_yubikey_confirm_message: "Disable YubiKey OTP for this account?",
    txt_disable_yubikey_failed: "Disable YubiKey failed",
