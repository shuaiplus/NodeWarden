...
const en: Record<string, string> = {
  ...
  "txt_domain_rules": "Domain Rules",
  "txt_domain_rules_help": "Manage custom equivalent domain groups for autofill. Add one domain per line in each group.",
  "txt_domain_rules_global_title": "Built-in Global Groups",
  "txt_domain_rules_global_help": "These default groups come from the server. Exclude a group to disable it, or customize it to copy the domains into your custom list.",
  "txt_domain_rules_custom_title": "Custom Groups",
  "txt_domain_rules_custom_help": "Custom groups are stored per account and are merged with enabled built-in groups during sync.",
  "txt_domain_rules_group": "Group",
  "txt_domain_rules_group_placeholder": "example.com\nlogin.example.com",
  "txt_domain_rules_one_domain_per_line": "One domain per line",
  "txt_domain_rules_add_group": "Add Group",
  "txt_domain_rules_include": "Include",
  "txt_domain_rules_exclude": "Exclude",
  "txt_domain_rules_customize": "Customize",
  "txt_domain_rules_global_included": "This built-in group is active.",
  "txt_domain_rules_global_excluded": "This built-in group is excluded.",
  "txt_domain_rules_empty_group": "This group cannot be empty.",
  "txt_domain_rules_saved": "Domain rules saved",
  "txt_domain_rules_save_failed": "Failed to save domain rules",
  "txt_domain_rules_load_failed": "Failed to load domain rules",
