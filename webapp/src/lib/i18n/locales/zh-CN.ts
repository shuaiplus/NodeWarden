...
const zhCN: Record<string, string> = {
  ...
  "txt_domain_rules": "域名规则",
  "txt_domain_rules_help": "管理自动填充使用的自定义等效域名分组。每个分组内每行填写一个域名。",
  "txt_domain_rules_global_title": "内置全局分组",
  "txt_domain_rules_global_help": "这些默认分组由服务器内置提供。可将分组排除以禁用，也可复制到自定义分组后再修改。",
  "txt_domain_rules_custom_title": "自定义分组",
  "txt_domain_rules_custom_help": "自定义分组按账户保存，并会在同步时与启用的内置分组合并使用。",
  "txt_domain_rules_group": "分组",
  "txt_domain_rules_group_placeholder": "example.com\nlogin.example.com",
  "txt_domain_rules_one_domain_per_line": "每行一个域名",
  "txt_domain_rules_add_group": "新增分组",
  "txt_domain_rules_include": "启用",
  "txt_domain_rules_exclude": "排除",
  "txt_domain_rules_customize": "自定义",
  "txt_domain_rules_global_included": "该内置分组当前已启用。",
  "txt_domain_rules_global_excluded": "该内置分组当前已排除。",
  "txt_domain_rules_empty_group": "该分组不能为空。",
