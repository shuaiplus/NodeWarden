...
const es: Record<string, string> = {
  ...
  "txt_domain_rules": "Reglas de dominio",
  "txt_domain_rules_help": "Administre grupos personalizados de dominios equivalentes para autocompletar. Agregue un dominio por línea en cada grupo.",
  "txt_domain_rules_global_title": "Grupos globales integrados",
  "txt_domain_rules_global_help": "Estos grupos predeterminados vienen del servidor. Puede excluir un grupo para desactivarlo o personalizarlo copiando sus dominios a la lista personalizada.",
  "txt_domain_rules_custom_title": "Grupos personalizados",
  "txt_domain_rules_custom_help": "Los grupos personalizados se guardan por cuenta y se combinan con los grupos integrados habilitados durante la sincronización.",
  "txt_domain_rules_group": "Grupo",
  "txt_domain_rules_group_placeholder": "example.com\nlogin.example.com",
  "txt_domain_rules_one_domain_per_line": "Un dominio por línea",
  "txt_domain_rules_add_group": "Añadir grupo",
  "txt_domain_rules_include": "Incluir",
  "txt_domain_rules_exclude": "Excluir",
  "txt_domain_rules_customize": "Personalizar",
  "txt_domain_rules_global_included": "Este grupo integrado está activo.",
  "txt_domain_rules_global_excluded": "Este grupo integrado está excluido.",
  "txt_domain_rules_empty_group": "Este grupo no puede estar vacío.",
