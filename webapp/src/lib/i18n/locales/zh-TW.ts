...
const zhTW: Record<string, string> = {
  ...
  "txt_domain_rules": "域名規則",
  "txt_domain_rules_help": "管理自定義等效域名分組，供自動填充使用。每個分組內每行填寫一個域名。",
  "txt_domain_rules_global_title": "內建全域分組",
  "txt_domain_rules_global_help": "這些預設分組由伺服器內建提供。可將分組排除以停用，也可複製到自定義分組後再修改。",
  "txt_domain_rules_custom_title": "自定義分組",
  "txt_domain_rules_custom_help": "自定義分組會按帳號保存，並在同步時與啟用的內建分組一併使用。",
  "txt_domain_rules_group": "分組",
  "txt_domain_rules_group_placeholder": "example.com\nlogin.example.com",
  "txt_domain_rules_one_domain_per_line": "每行一個域名",
  "txt_domain_rules_add_group": "新增分組",
  "txt_domain_rules_include": "啟用",
  "txt_domain_rules_exclude": "排除",
  "txt_domain_rules_customize": "自定義",
  "txt_domain_rules_global_included": "此內建分組目前已啟用。",
  "txt_domain_rules_global_excluded": "此內建分組目前已排除。",
  "txt_domain_rules_empty_group": "此分組不能為空。",
