...
const ru: Record<string, string> = {
  ...
  "txt_domain_rules": "Правила доменов",
  "txt_domain_rules_help": "Управляйте пользовательскими группами эквивалентных доменов для автозаполнения. Добавляйте по одному домену в строке внутри каждой группы.",
  "txt_domain_rules_global_title": "Встроенные глобальные группы",
  "txt_domain_rules_global_help": "Эти группы по умолчанию встроены на сервере. Группу можно исключить или перенести в пользовательский список для дальнейшего редактирования.",
  "txt_domain_rules_custom_title": "Пользовательские группы",
  "txt_domain_rules_custom_help": "Пользовательские группы сохраняются для учетной записи и объединяются с включенными встроенными группами при синхронизации.",
  "txt_domain_rules_group": "Группа",
  "txt_domain_rules_group_placeholder": "example.com\nlogin.example.com",
  "txt_domain_rules_one_domain_per_line": "Один домен в строке",
  "txt_domain_rules_add_group": "Добавить группу",
  "txt_domain_rules_include": "Включить",
  "txt_domain_rules_exclude": "Исключить",
  "txt_domain_rules_customize": "Настроить",
  "txt_domain_rules_global_included": "Эта встроенная группа активна.",
  "txt_domain_rules_global_excluded": "Эта встроенная группа исключена.",
  "txt_domain_rules_empty_group": "Эта группа не может быть пустой.",
